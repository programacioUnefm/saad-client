...
export const SidebarColapse = ({ menu }) => {
  ...
  const buttonClass = `w-[45px] h-[40px] flex justify-center items-center p-0 text-foreground/60 border border-input  hover:bg-accent hover:text-accent-foreground uppercase rounded-md transition-all`;
  return (
