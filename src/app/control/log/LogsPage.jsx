...
export const LogsPage = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (info) => (
        <div className='font-bold text-center uppercase'>{info.getValue()}</div>
      )
    },
    {
      id: 'id usuario',
    ...
    },
    {
      ...
      classname: 'text-center',
      cell: (info) => (
        <Badge className='bg-accent text-[10px] text-foreground hover:text-white text-center uppercase'>{info.getValue()}</Badge>
      )
    },
    {
      id: 'ip',
      ...
      cell: (info) => (
        <Badge className='bg-accent text-[10px] text-foreground hover:text-white uppercase'>{info.getValue()}</Badge>
      )
    },
...

    {
      ...
      cell: (info) => (
        ...
        <div className='tooltip'>
          <Badge className='text-center line-clamp-1' variant='outline'>
            {info.getValue()}
          </Badge>
...

    {
      ...
      cell: (info) => (
        <div className='tooltip'>
          <Badge className='min-w-[50px] max-w-[120px] text-center line-clamp-1' variant='outline'>
